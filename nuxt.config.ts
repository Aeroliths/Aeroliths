    ...
    locales: [
      {
        ...
        language: 'en-US',
        name: 'English',
        files: ['en/common.json', 'en/home.json', 'en/rules.json', 'en/play.json', 'en/auth.json', 'en/settings.json', 'en/friends.json', 'en/leaderboard.json', 'en/news.json'],
      },
      {
        code: 'fr',
        language: 'fr-FR',
        name: 'Français',
        files: ['fr/common.json', 'fr/home.json', 'fr/rules.json', 'fr/play.json', 'fr/auth.json', 'fr/settings.json', 'fr/friends.json', 'fr/leaderboard.json', 'fr/news.json'],
      },
    ],
    defaultLocale: 'en',
